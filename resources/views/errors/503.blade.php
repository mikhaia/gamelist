...
<head>
    ...
    <link rel="preload" href="/fonts/material-symbols-outlined.woff2?v=20260717-5" as="font" type="font/woff2" crossorigin>
    ...
    <style>
        @font-face {
            ...
            font-weight: 400;
            font-display: block;
            src: url('/fonts/material-symbols-outlined.woff2?v=20260717-5') format('woff2');
        }
