...
class AchievementService
{
    ...
    private function counts(User $user): array
    {
        ...
        return [
            ...
            'completed' => (clone $games)->whereIn('status', [GameStatus::Completed->value, GameStatus::Completed100->value])->count(),
            'wishlist' => (clone $games)->where('status', GameStatus::WantToPlay->value)->count(),
            'playing' => (clone $games)->whereIn('status', [GameStatus::Playing->value, GameStatus::Replaying->value])->count(),
